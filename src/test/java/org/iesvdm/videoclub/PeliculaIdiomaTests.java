...
public class PeliculaIdiomaTests {
    ...
    void grabarMultiplesPeliculasIdioma() {
        ...
        idioma2.getPeliculasIdioma().add(pelicula3);
    ...
    void actualizarIdiomaPeliculaAOtroIdioma() {
        ...
        idioma2.getPeliculasIdioma().add(pelicula2);
    ...
    void eliminarPeliculasAsociadasAIdioma() {
        ...
        idioma2.getPeliculasIdioma().forEach(pelicula -> {//pelicula.setIdioma(null);
    ...
    void eliminarPeliculasAsociadasAIdiomaEIdioma() {
        ...
        idioma1.getPeliculasIdioma().forEach(pelicula -> {//pelicula.setIdioma(null);
            peliculaRepository.delete(pelicula);
        });
